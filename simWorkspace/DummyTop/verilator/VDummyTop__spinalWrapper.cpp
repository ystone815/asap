...
class Wrapper_3206969451486889921;
thread_local Wrapper_3206969451486889921 *simHandle3206969451486889921;
...
public:
    ...
    Wrapper_3206969451486889921(const char * name, const char * wavePath, int seed){
      //contextp = new VerilatedContext;
      Verilated::randReset(2);
      Verilated::randSeed(seed);
      top = new VDummyTop();

      simHandle3206969451486889921 = this;
      time = 0;
      timeCheck = 0;
      lastFlushAt = high_resolution_clock::now();
      waveEnabled = true;
      signalAccess[0] = new SDataSignalAccess( top->io_qM1Size );
      signalAccess[1] = new SDataSignalAccess( top->io_qM2Size );
      signalAccess[2] = new SDataSignalAccess( top->io_qMemSize );
      signalAccess[3] = new IDataSignalAccess( top->io_totalProcessed );
    ...
    virtual ~Wrapper_3206969451486889921(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/stone/assap/./simWorkspace/DummyTop/$TEST/") + name + ".dat").c_str());
      #endif
...
double sc_time_stamp () {
  return simHandle3206969451486889921->time;
}
...
JNIEXPORT Wrapper_3206969451486889921 * API JNICALL Java_wrapper_1verilator_VerilatorNative_newHandle_13206969451486889921
  (JNIEnv * env, jobject obj, jstring name, jstring wavePath, jint seedValue){
    ...
    Wrapper_3206969451486889921 *handle = new Wrapper_3206969451486889921(ch, wavePathCh, seedValue);
    env->ReleaseStringUTFChars(name, ch);
    env->ReleaseStringUTFChars(wavePath, wavePathCh);
    return handle;
}

JNIEXPORT jboolean API JNICALL Java_wrapper_1verilator_VerilatorNative_eval_13206969451486889921
  (JNIEnv *, jobject, Wrapper_3206969451486889921 *handle){
   handle->top->eval();
   return Verilated::gotFinish();
}

JNIEXPORT jint API JNICALL Java_wrapper_1verilator_VerilatorNative_getTimePrecision_13206969451486889921
  (JNIEnv *, jobject, Wrapper_3206969451486889921 *handle){
  return handle->time_precision;
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_sleep_13206969451486889921
  (JNIEnv *, jobject, Wrapper_3206969451486889921 *handle, uint64_t cycles){
  #ifdef TRACE
...
JNIEXPORT jlong API JNICALL Java_wrapper_1verilator_VerilatorNative_getU64_13206969451486889921
  (JNIEnv *, jobject, Wrapper_3206969451486889921 *handle, int id){
  return handle->signalAccess[id]->getU64();
}

JNIEXPORT jlong API JNICALL Java_wrapper_1verilator_VerilatorNative_getU64mem_13206969451486889921
  (JNIEnv *, jobject, Wrapper_3206969451486889921 *handle, int id, uint64_t index){
  return handle->signalAccess[id]->getU64_mem(index);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_setU64_13206969451486889921
  (JNIEnv *, jobject, Wrapper_3206969451486889921 *handle, int id, uint64_t value){
  handle->signalAccess[id]->setU64(value);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_setU64mem_13206969451486889921
  (JNIEnv *, jobject, Wrapper_3206969451486889921 *handle, int id, uint64_t value, uint64_t index){
  handle->signalAccess[id]->setU64_mem(value, index);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_deleteHandle_13206969451486889921
  (JNIEnv *, jobject, Wrapper_3206969451486889921 * handle){
  delete handle;
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_getAU8_13206969451486889921
  (JNIEnv * env, jobject obj, Wrapper_3206969451486889921 * handle, jint id, jbyteArray value){
  handle->signalAccess[id]->getAU8(env, value);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_getAU8mem_13206969451486889921
  (JNIEnv * env, jobject obj, Wrapper_3206969451486889921 * handle, jint id, jbyteArray value, uint64_t index){
  handle->signalAccess[id]->getAU8_mem(env, value, index);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_setAU8_13206969451486889921
  (JNIEnv * env, jobject obj, Wrapper_3206969451486889921 * handle, jint id, jbyteArray value, jint length){
  handle->signalAccess[id]->setAU8(env, value, length);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_setAU8mem_13206969451486889921
  (JNIEnv * env, jobject obj, Wrapper_3206969451486889921 * handle, jint id, jbyteArray value, jint length, uint64_t index){
  handle->signalAccess[id]->setAU8_mem(env, value, length, index);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_enableWave_13206969451486889921
  (JNIEnv *, jobject, Wrapper_3206969451486889921 * handle){
  handle->waveEnabled = true;
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_disableWave_13206969451486889921
  (JNIEnv *, jobject, Wrapper_3206969451486889921 * handle){
