...
class Wrapper_5114424574974238292;
thread_local Wrapper_5114424574974238292 *simHandle5114424574974238292;
...
public:
    ...
    Wrapper_5114424574974238292(const char * name, const char * wavePath, int seed){
      //contextp = new VerilatedContext;
      Verilated::randReset(2);
      Verilated::randSeed(seed);
      top = new VNativePerfSystem();

      simHandle5114424574974238292 = this;
      time = 0;
      timeCheck = 0;
      lastFlushAt = high_resolution_clock::now();
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top->io_enable );
      signalAccess[1] = new IDataSignalAccess( top->io_totalTxns );
    ...
    virtual ~Wrapper_5114424574974238292(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/stone/assap/./simWorkspace/NativePerfSystem/$TEST/") + name + ".dat").c_str());
      #endif
...
double sc_time_stamp () {
  return simHandle5114424574974238292->time;
}
...
JNIEXPORT Wrapper_5114424574974238292 * API JNICALL Java_wrapper_1verilator_VerilatorNative_newHandle_15114424574974238292
  (JNIEnv * env, jobject obj, jstring name, jstring wavePath, jint seedValue){
    ...
    Wrapper_5114424574974238292 *handle = new Wrapper_5114424574974238292(ch, wavePathCh, seedValue);
    env->ReleaseStringUTFChars(name, ch);
    env->ReleaseStringUTFChars(wavePath, wavePathCh);
    return handle;
}

JNIEXPORT jboolean API JNICALL Java_wrapper_1verilator_VerilatorNative_eval_15114424574974238292
  (JNIEnv *, jobject, Wrapper_5114424574974238292 *handle){
   handle->top->eval();
   return Verilated::gotFinish();
}

JNIEXPORT jint API JNICALL Java_wrapper_1verilator_VerilatorNative_getTimePrecision_15114424574974238292
  (JNIEnv *, jobject, Wrapper_5114424574974238292 *handle){
  return handle->time_precision;
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_sleep_15114424574974238292
  (JNIEnv *, jobject, Wrapper_5114424574974238292 *handle, uint64_t cycles){
  #ifdef TRACE
...
JNIEXPORT jlong API JNICALL Java_wrapper_1verilator_VerilatorNative_getU64_15114424574974238292
  (JNIEnv *, jobject, Wrapper_5114424574974238292 *handle, int id){
  return handle->signalAccess[id]->getU64();
}

JNIEXPORT jlong API JNICALL Java_wrapper_1verilator_VerilatorNative_getU64mem_15114424574974238292
  (JNIEnv *, jobject, Wrapper_5114424574974238292 *handle, int id, uint64_t index){
  return handle->signalAccess[id]->getU64_mem(index);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_setU64_15114424574974238292
  (JNIEnv *, jobject, Wrapper_5114424574974238292 *handle, int id, uint64_t value){
  handle->signalAccess[id]->setU64(value);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_setU64mem_15114424574974238292
  (JNIEnv *, jobject, Wrapper_5114424574974238292 *handle, int id, uint64_t value, uint64_t index){
  handle->signalAccess[id]->setU64_mem(value, index);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_deleteHandle_15114424574974238292
  (JNIEnv *, jobject, Wrapper_5114424574974238292 * handle){
  delete handle;
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_getAU8_15114424574974238292
  (JNIEnv * env, jobject obj, Wrapper_5114424574974238292 * handle, jint id, jbyteArray value){
  handle->signalAccess[id]->getAU8(env, value);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_getAU8mem_15114424574974238292
  (JNIEnv * env, jobject obj, Wrapper_5114424574974238292 * handle, jint id, jbyteArray value, uint64_t index){
  handle->signalAccess[id]->getAU8_mem(env, value, index);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_setAU8_15114424574974238292
  (JNIEnv * env, jobject obj, Wrapper_5114424574974238292 * handle, jint id, jbyteArray value, jint length){
  handle->signalAccess[id]->setAU8(env, value, length);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_setAU8mem_15114424574974238292
  (JNIEnv * env, jobject obj, Wrapper_5114424574974238292 * handle, jint id, jbyteArray value, jint length, uint64_t index){
  handle->signalAccess[id]->setAU8_mem(env, value, length, index);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_enableWave_15114424574974238292
  (JNIEnv *, jobject, Wrapper_5114424574974238292 * handle){
  handle->waveEnabled = true;
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_disableWave_15114424574974238292
  (JNIEnv *, jobject, Wrapper_5114424574974238292 * handle){
